...
import {
  ...
  ROULETTE_EUROPEAN_GAME_TYPE,
  useLiveResultAdminSocket,
  useLuckyLiveDisplaySeconds,
  type LuckyGameStatusOk,
} from "@/lib/luckyGameAdmin";

const GAME_TYPE = ROULETTE_EUROPEAN_GAME_TYPE;

/** European Roulette: 0–9 / 10–19 / 20–29 / 30–36 — single zero only. */
...
export default function EuropeanRouletteLiveResultPage() {
  useRequireAdmin();
  ...
  return (
    <section className="w-full min-w-0 overflow-x-hidden rounded-xl border bg-white p-2 shadow-sm sm:p-3 md:p-4">
      <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-4">
        <h1 className="text-[14px] font-medium text-gray-900">European Roulette</h1>
        <button
          type="button"
          disabled={resetBusy}
